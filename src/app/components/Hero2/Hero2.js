        ...
        <div className="px-6 pt-6 lg:max-w-2xl lg:pl-8 lg:pr-0">
          <nav className="flex items-center justify-between lg:justify-between" aria-label="Global">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">NeuraFox</span>
              <Image src="/images/logo03.png" alt="NeuraFox Logo" width={64} height={150} />
            </a>
            <button
              type="button"
            ...
            <div className="hidden lg:ml-12 lg:flex lg:gap-x-14 lg:ml-auto">
              {navigation.map((item) => (
          ...
          <div className="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
            ...
            <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                ...
                Craft Web Applications with Just Your Words
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  NeuraFox introduces a GPT4-driven words-to-web platform, catering to entrepreneurs, advisors, and local enterprises. 
